var FormAction = {
    ...
    imagesControl : function(){
        ...
        $addImageLink.on('click', function(e) {
            ...
            $('#imageCatalogModal__' + idLi + " #translations-fields a:first").tab("show");
            var tabs = $('#imageCatalogModal__' + idLi + " .tab-pane");
            tabs.hide();
            tabs.eq(0).show();
            $('#imageCatalogModal__' + idLi + " #translations-fields a").click(function(e){
    ...
    filesControl : function(){
        ...
        $addFileLink.on('click', function(e) {
            ...
            $('#fileCatalogModal__' + idLi + " #translations-fields a:first").tab("show");
            var tabs = $('#fileCatalogModal__' + idLi + " .tab-pane");
            tabs.hide();
            tabs.eq(0).show();
            $('#fileCatalogModal__' + idLi + " #translations-fields a").click(function(e){
                var box = $(this).parents('.symfony-form-row-translations');
                box.find('.tab-pane').hide();
                box.find($(this).attr('href')).show();
                $(this).tab('show');
    ...
    translationTab : function(){
        $('.symfony-form-row-translations').each(function(i){
            $(this).find("#translations-fields a:first").tab("show");
            $(this).find(".tab-pane").hide().eq(0).show();
            $(this).find("#translations-fields a").click(function(e){
                e.preventDefault();
                var box = $(this).parents('.symfony-form-row-translations');
                box.find('.tab-pane').hide();
                box.find($(this).attr('href')).show();
